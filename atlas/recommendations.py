...
def _cross_project_recommendations(portfolio: Portfolio) -> list[Recommendation]:
    ...
    type_to_category = {
        ...
        "image_lib_divergence": "deps",
        "data_viz_divergence": "deps",
        "geo_lib_divergence": "deps",
        "media_lib_divergence": "deps",
        "math_lib_divergence": "deps",
        "async_lib_divergence": "deps",
        "crypto_lib_divergence": "deps",
        "pdf_lib_divergence": "deps",
        "email_lib_divergence": "deps",
        "compression_lib_divergence": "deps",
        "a11y_divergence": "quality",
        "scraping_lib_divergence": "deps",
        "desktop_framework_divergence": "deps",
        "file_storage_divergence": "infra",
        "form_lib_divergence": "deps",
        "animation_lib_divergence": "deps",
        ...
        "e2e_divergence": "tests",
        "monorepo_divergence": "infra",
        "error_tracking_divergence": "infra",
        "ssg_divergence": "deps",
